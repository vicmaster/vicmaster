...
* 👩‍💻[Clade Code Cookbook]([claude-code-cookbook](https://github.com/vicmaster/claude-code-cookbook)) - Tested, copy-pasteable recipes for Claude Code: hooks, slash commands, subagents, and settings.
